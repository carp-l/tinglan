...
const CONFIG = { // 主配置对象，包含网站所有配置项
    ...
    // ====================================
    site: { // 网站基础信息配置
        title: "庭兰 - 燕云十六声百业搜索", // 网站标题，显示在浏览器标签页
        description: "闲坐听风语，庭兰伴清欢。" // 网站描述，用于SEO优化
    },
    ...
    hero: { // 首页区域配置
        ...
        title: "庭兰", // 首页主标题文字
        // 首页副标题
        subtitle: "闲坐听风语，庭兰伴清欢呈", // 首页副标题描述文字
        // 首页背景
    ...
    footer: { // 页脚区域配置
        ...
        sections: [ // 页脚内容区块数组
            ...
            { // 第三个页脚区块
                title: "关注我们", // 区块标题
                social: [ // 社交媒体链接数组
                    { platform: "作者", account: "xiaoyu" } // 社交平台信息对象
                ]
            }
        ],
        copyright: "&copy; 2026 庭兰. 保留所有权利." // 版权信息文字
    },
