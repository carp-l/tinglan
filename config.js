...
const CONFIG = { // 主配置对象，包含网站所有配置项
    ...
    // ====================================
    site: { // 网站基础信息配置
        title: "风华无缺 - 燕云十六声百业搜索", // 网站标题，显示在浏览器标签页
        description: "风华无缺致力于展示各流派咸鱼人生的风采。" // 网站描述，用于SEO优化
    },
    ...
    hero: { // 首页区域配置
        ...
        title: "风华无缺", // 首页主标题文字
        // 首页副标题
        subtitle: "风华绝代，无缺人生，百业路远，精彩纷呈", // 首页副标题描述文字
        // 首页背景
    ...
    about: { // 关于我们区域配置
        ...
        subtitle2: "风华无缺", // 关于我们区域副标题2
        background: "#1A202C", // 关于我们区域背景色
        content: { // 关于我们区域内容配置
            text1: [ // 第一个文本区域内容数组
                "风华无缺致力于展示各流派咸鱼人生的风采。", // 第一段文字内容
    ...
    footer: { // 页脚区域配置
        ...
        sections: [ // 页脚内容区块数组
            ...
            { // 第三个页脚区块
                title: "关注我们", // 区块标题
                social: [ // 社交媒体链接数组
                    { platform: "抖音", account: "峰伈" } // 社交平台信息对象
                ]
            }
        ],
        copyright: "&copy; 2025 风华无缺. 保留所有权利." // 版权信息文字
    },
